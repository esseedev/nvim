return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>sF', function()
      builtin.find_files { cwd = _G.nvim_startup_dir }
    end, { desc = '[S]earch [F]iles from project root' })
    vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
    vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[S]earch current [W]ord' })
    vim.keymap.set('n', '<leader>sW', function()
      builtin.grep_string { cwd = _G.nvim_startup_dir }
    end, { desc = '[S]earch current [W]ord from project root' })
    vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' })
    vim.keymap.set('n', '<leader>sG', function()
      builtin.live_grep { cwd = _G.nvim_startup_dir }
    end, { desc = '[S]earch by [G]rep from root' })
